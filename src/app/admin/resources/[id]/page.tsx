...
import { ArrowLeft, Save, Loader2, FileText, Video, File, ExternalLink, Trash2 } from 'lucide-react';
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 hover:bg-red-200 dark:hover:bg-red-900/50 font-medium transition-colors"
          >
